...
if __name__ == "__main__":
    for component in ["Questionnaire", "Examination", "Laboratory", "Dietary"]:
        print(f"\n=== Downloading NHANES {component} datasets ===")
        download_and_convert_all_nhanes(
            base_url=f"https://wwwn.cdc.gov/nchs/nhanes/search/datapage.aspx?Component={component}",
